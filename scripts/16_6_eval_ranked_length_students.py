#!/usr/bin/env python3
"""Launch the locked GSM8K evaluation for ranked-length adapters and base."""
...
def main() -> None:
    ...
    manifest = {
        ...
        "validation_source_sha256": file_sha256(
            PROJECT_ROOT / "src/length_budget_distill/ranked_evaluation.py"
        ),
    ...
    logging.info("ranked_length_evaluation_complete manifest=%s", manifest_path)
    ...
    while pending or running:
        while pending and len(running) < max_parallel and available_gpus:
            ...
            if evidence is not None:
                ...
                expected_support = _check_support(expected_support, evidence["problem_ids"], entry["model_id"])
